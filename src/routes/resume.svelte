<div class="">
    ...
    <p>
    Full stack web developer. Have more than 5 years of experience designing and implementing web applications in Python, PHP, JavaScript, and React.
    </p>
    <ul>
    ...
    <ul>
    <li>Building custom modular lead capture tools for marketing</li>
    ...
    <li>Technologies: Python, Django, Django Rest Framework, Node.js, JavaScript ES5, ES6, Vue.js, React.js, AWS Lambda, S3, Cloudfront, SES, Elastic Beanstalk, API Gateway, WordPress, Travis, Google Analytics (GA)</li>
    </ul>
